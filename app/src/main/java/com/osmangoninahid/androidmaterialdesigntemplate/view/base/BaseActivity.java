...
import com.osmangoninahid.androidmaterialdesigntemplate.util.LogUtil.*;
import com.osmangoninahid.androidmaterialdesigntemplate.view.SettingsActivity;
import com.osmangoninahid.androidmaterialdesigntemplate.view.ViewSampleActivity;
import com.osmangoninahid.androidmaterialdesigntemplate.view.quote.ListActivity;
    ...
    private void goToNavDrawerItem(int item) {
        switch (item) {
            ...
            case R.id.nav_samples:
                startActivity(new Intent(this, ViewSampleActivity.class));
                break;
